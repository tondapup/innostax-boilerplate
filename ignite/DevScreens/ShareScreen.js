...
import { AppRegistry, StyleSheet,View, ScrollView, Text, Image, TouchableOpacity, Clipboard, ToastAndroid, AlertIOS, Platform } from 'react-native'
    ...
    return (
      <View style={[styles.container, styles.mainContainer]}>
        ...
        <TouchableOpacity onPress={()=>{
          ...
          <View style={styles1.instructions}>
